...
const startConnection = (nodeId, portName, type, event) => {
  event.stopPropagation()
...
const addConnection = (fromNodeId, fromPort, toNodeId, toPort) => {
  connections.value = connections.value.filter(
...
const getPortPosition = (nodeId, portName, isOutput) => {
